from telemetryPIClient import Client
from telemetryFileHandler import TelemetryFileHandler
...
if __name__ == "__main__":
    ...
    serverPort = 5002
    filePort = 5003
    system = TelemetrySystem(server= websiteServer, serverPort= serverPort, filePort= filePort)
    system.run()
